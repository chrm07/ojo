        ...
        <main class="main-content">
            ...
            <section id="mod-projects" class="module">
                ...
                <div id="project-details-view" style="display:none;">
                    <div style="margin-bottom: 24px;">
                        ...
                        <h2 id="pd-name" style="color: var(--text-dark); font-weight: 800; font-size: 1.8rem;">Project Name</h2>
            ...
            <section id="mod-payroll" class="module">
                <div id="payroll-active-view">
                    <div class="card">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px;">
                            <h3 style="font-weight:800; font-size:1.2rem;"><i class="fa-solid fa-file-invoice-dollar"></i> Current Payroll Cycle</h3>
                        ...
                        <div class="form-grid">
                            ...
                            <input type="text" id="pay-name" list="pay-name-list" placeholder="Search Worker Name" required>
                            <datalist id="pay-name-list"></datalist>
                            <input type="text" id="pay-job" placeholder="Job Description" required>
                            <input type="number" step="0.5" id="pay-days" placeholder="Days Worked" required>
                            <input type="number" id="pay-deduc" placeholder="Deductions (₱)">
                        ...
                        <div class="table-responsive"><table class="sheet-table" id="table-payroll"><thead><tr><th>Date</th><th>Name</th><th>Job Desc.</th><th>Rate</th><th>Days</th><th>Gross</th><th>Deductions</th><th>Net Pay</th></tr></thead><tbody></tbody></table></div>
                    </div>
                </div>
                <div id="payroll-history-view" style="display: none;">
                    <div class="card">
                        ...
                        <h3 style="margin-bottom: 24px; color: var(--text-dark); font-weight:800; font-size:1.2rem;"><i class="fa-solid fa-box-archive"></i> Payroll History</h3>
                        <div class="table-responsive"><table class="sheet-table" id="table-payroll-history"><thead><tr><th>Cycle ID</th><th>Date Paid</th><th>Name</th><th>Job Description</th><th>Rate</th><th>Net Pay</th></tr></thead><tbody></tbody></table></div>
                    </div>
                </div>
            </section>
