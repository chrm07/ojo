            ...
            <section id="mod-dashboard" class="module active">
                ...
                <div id="global-search-results" class="card" style="display:none;">
                    <div class="card-header" style="border-bottom: 1px solid var(--border); padding-bottom: 16px; margin-bottom: 16px;">
                        ...
                        <p style="font-size: 0.85rem; color: var(--text-muted); margin-top: 4px;">Found results matching "<b id="search-query-display" style="color:var(--text-dark);"></b>"</p>
                    </div>
            ...
            <section id="mod-projects" class="module">
                ...
                <div id="project-details-view" style="display:none;">
                    ...
                    <div id="ptab-progress" class="proj-section active">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px;">
                            ...
                            <div id="add-category-container">
                                ...
                                <input type="text" id="input-add-cat" class="inline-input" style="display:none; height: 32px;" placeholder="New Category Name..." onblur="app.saveNewCategoryDB(this.value)" onkeydown="if(event.key==='Enter') this.blur()">
                            </div>
                        </div>
                    ...
                    <div id="ptab-materials" class="proj-section">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <p>Items issued here will automatically be deducted from the main inventory.</p>
                            </div>
                    ...
                    <div id="ptab-manpower" class="proj-section">
                        <div class="card">
                            <div class="card-header">
                                <h3><i class="fa-solid fa-users-gear" style="color:var(--text-dark);"></i> Category Assignments</h3>
                                <p>Assign workers to checklist categories. Completed tasks auto-sync to their Payroll Breakdown.</p>
                            </div>
                            ...
                            <div style="margin-top: 24px;">
                                <div class="table-responsive">
                                    <table class="sheet-table">
                                        <thead><tr><th>Checklist Category</th><th>Assigned Personnel</th><th>Action</th></tr></thead>
                    ...
                    <div class="card">
                        ...
                        <div class="table-responsive">
                            <table class="sheet-table" id="table-users">
                                <thead><tr><th>Name</th><th>Project Assigned</th><th>Skills</th><th>Position</th><th>Rate</th><th>Bio Data</th></tr></thead>
                                <tbody></tbody>
                            </table>
                        </div>
                    </div>
            ...
            <section id="mod-payroll" class="module">
                <div id="payroll-active-view">
                    <div class="card">
                        ...
                        <div class="form-grid" style="grid-template-columns: 1fr 1.5fr 2fr 1fr 1fr; align-items:center; background: #F8FAFC;">
                            ...
                            <input type="text" id="pay-job" placeholder="Job/Unit Description">
                            <input type="number" id="pay-award" placeholder="Award Cost (₱)">
                            <input type="number" id="pay-advance" placeholder="Cash Advance (₱)">
                ...
                <div id="payroll-history-view" style="display: none;">
                    <div class="card">
                        ...
                        <div class="table-responsive"><table class="sheet-table" id="table-payroll-history"><thead><tr><th>Cycle ID</th><th>Date Paid</th><th>Name</th><th>Job Description</th><th>Net Pay</th></tr></thead><tbody></tbody></table></div>
                    </div>
                </div>
            </section>
                ...
                <div class="card">
                    ...
                    <div class="table-responsive">
                        <table class="sheet-table" id="table-global-ntp">
                            <thead><tr><th>Project</th><th>Ticket</th><th>NTP Date</th><th>Award Cost</th><th>Due Date</th><th>Accept Date</th><th>Document</th></tr></thead>
                            <tbody></tbody>
                        </table>
                    </div>
                </div>
