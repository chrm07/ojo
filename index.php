...
<body>
        ...
        <main class="main-content">
            <header class="header">
                ...
                <div class="header-right">
                    <div class="user-profile">
                        ...
                        <div class="user-info"><span class="user-name">System Admin</span><span class="user-role">Project Manager</span></div>
                    </div>
                </div>
            </header>
            ...
            <section id="mod-projects" class="module">
                <div id="projects-list-view">
                    <div class="card">
                        <div class="card-header"><h3><i class="fa-solid fa-layer-group"></i> Create New Project / Site</h3></div>
                        <div class="form-grid">
                            ...
                            <div style="grid-column: 1 / -1; display: flex; justify-content: flex-end; margin-top: 4px;"><button type="button" class="btn" onclick="app.submitProjectForm()"><i class="fa-solid fa-plus"></i> Create Project</button></div>
                        </div>
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px;">
                            <div style="position: relative; width: 250px;"><i class="fa-solid fa-magnifying-glass" style="position: absolute; left: 10px; top: 50%; transform: translateY(-50%); color: var(--text-muted);"></i><input type="text" id="search-projects-table" placeholder="Search Projects..." style="width: 100%; padding-left: 32px; border-radius: 6px; border: 1px solid var(--border); height: 32px; font-size: 12px;"></div>
                            <div style="display: flex; align-items: center; gap: 8px;"><span style="font-weight: 600; color: var(--text-muted); font-size: 0.8rem;">Filter:</span><select id="filter-projects" style="width: 130px; height: 32px; border-radius: 6px; border: 1px solid var(--border); font-size: 12px;"><option value="all">All Projects</option><option value="pending">Pending</option><option value="ongoing">Ongoing</option><option value="completed">Completed</option></select></div>
                        </div>
                        <div class="table-responsive"><table class="sheet-table" id="table-projects"><thead><tr><th>Project Name</th><th>Foreman</th><th>Location</th><th>Start Date</th><th>Status</th><th>Action</th></tr></thead><tbody></tbody></table></div>
                    </div>
                </div>

                <div id="project-details-view" style="display:none;">
                    <div style="margin-bottom: 24px; display: flex; gap: 16px; align-items: flex-start;">
                        <button class="btn-outline" onclick="app.closeProjectDetails()" style="height: 32px; padding: 0 12px; font-size: 0.75rem; color: var(--text-muted);"><i class="fa-solid fa-arrow-left"></i> Back to List</button>
                        <div>
                            <h2 id="pd-name" style="color: var(--text-dark); font-weight: 800; font-size: 1.8rem; margin-bottom:4px; line-height: 1;">Project Name</h2>
                            <p style="color: var(--text-muted); font-size: 0.9rem;"><i class="fa-solid fa-location-dot" style="color: var(--primary-hover);"></i> <span id="pd-loc-display">Location</span></p>
                        </div>
                    </div>
                    ...
                    <div class="proj-tabs">
                        ...
                        <div class="proj-tab" id="tab-manpower" onclick="app.switchProjectTab('manpower')"><i class="fa-solid fa-users-gear"></i> Manpower Assignment</div>
                    </div>
                    ...
                    <div id="ptab-progress" class="proj-section active">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px;">
                            <div class="card" style="padding: 16px 20px; flex: 1; margin-bottom: 0; margin-right: 16px;">
                                <div style="display: flex; justify-content: space-between; align-items: center;"><span style="font-weight: 800; color: var(--text-dark); font-size: 0.95rem;">Overall Project Progress</span><span id="proj-progress-text" style="font-weight: 900; color: var(--text-dark); font-size: 1.2rem;">0%</span></div>
                    ...
                    <div id="ptab-materials" class="proj-section">
                        <div class="quick-stats-grid" style="grid-template-columns: 1fr 1fr;">
                            <div class="stat-card" style="padding: 16px 20px;"><div class="stat-details"><h3>Materials Issued (Total)</h3><h2 id="proj-summary-qty">0 Items</h2></div><div class="stat-icon" style="background:#EFF6FF; color:#3B82F6;"><i class="fa-solid fa-boxes-stacked"></i></div></div>
                            <div class="stat-card" style="padding: 16px 20px;"><div class="stat-details"><h3>Total Cost Allocation</h3><h2 id="proj-summary-cost" style="color:var(--success);">₱0.00</h2></div><div class="stat-icon" style="background:var(--success-bg); color:var(--success);"><i class="fa-solid fa-peso-sign"></i></div></div>
                        </div>
                        <div class="card">
                            <div class="card-header"><h3><i class="fa-solid fa-clipboard-list" style="color:var(--text-dark);"></i> Log Material Issuance</h3></div>
                            <div class="form-grid" style="grid-template-columns: 2fr 1fr 1.5fr auto; align-items:center;">
                                ...
                                <button class="btn" onclick="app.issueMaterial()"><i class="fa-solid fa-check"></i> Issue</button>
                            </div>
                            <div style="margin-top: 24px;">
                                <h4 style="font-weight: 800; font-size: 1rem; margin-bottom:12px; color:var(--text-dark);">Issuance History</h4>
                                <div class="table-responsive"><table class="sheet-table"><thead><tr><th>Date</th><th>Item Issued</th><th>Quantity</th><th>Total Cost</th><th>Received By</th></tr></thead><tbody id="issuance-history-content"></tbody></table></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="ptab-manpower" class="proj-section">
                        <div class="card">
                            <div class="card-header"><h3><i class="fa-solid fa-users-gear" style="color:var(--text-dark);"></i> Category Assignments</h3><p>Assign workers to checklist categories. Completed tasks auto-sync to their Payroll Breakdown.</p></div>
                            <div class="form-grid" style="grid-template-columns: 1fr 1fr auto; align-items:center;">
                                <select id="assign-category"><option value="">Select Category/Phase</option></select>
                                <select id="assign-worker"><option value="">Select Worker</option></select>
                                <button class="btn" onclick="app.assignWorkerToCategory()"><i class="fa-solid fa-link"></i> Assign Person</button>
                            </div>
                            <div style="margin-top: 24px;">
                                <div class="table-responsive"><table class="sheet-table"><thead><tr><th>Checklist Category</th><th>Assigned Personnel</th><th>Action</th></tr></thead><tbody id="assignments-content"></tbody></table></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section id="mod-materials" class="module">
                <div class="quick-stats-grid" style="grid-template-columns: repeat(auto-fit, minmax(240px, 1fr));">
                    <div class="stat-card"><div class="stat-details"><h3>Active Suppliers</h3><h2 id="stat-active-suppliers">0</h2></div><div class="stat-icon" style="background:#D1FAE5; color:#10B981;"><i class="fa-solid fa-truck-fast"></i></div></div>
                    <div class="stat-card"><div class="stat-details"><h3>Pending Deliveries</h3><h2 id="stat-pending-deliveries">0</h2></div><div class="stat-icon" style="background:#FEF3C7; color:#F59E0B;"><i class="fa-solid fa-clock-rotate-left"></i></div></div>
                    <div class="stat-card"><div class="stat-details"><h3>Low Stock Alerts</h3><h2 id="stat-low-stock">0 Items</h2></div><div class="stat-icon" style="background:#FEE2E2; color:#EF4444;"><i class="fa-solid fa-triangle-exclamation"></i></div></div>
                </div>
                <div class="card" style="padding-top: 10px;">
                    ...
                    <div id="mtab-suppliers" class="proj-section active">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                            <div><h3 style="color: var(--text-dark); font-weight: 800; font-size: 1.1rem;">Supplier Directory</h3></div>
                            <button class="btn" onclick="app.openModal('modal-add-supplier')"><i class="fa-solid fa-plus"></i> Add New Supplier</button>
                        </div>
                        <div class="table-responsive"><table class="sheet-table" id="table-suppliers"><thead><tr><th>Supplier Name</th><th>Items Provided</th><th>Contact Number</th><th>Email Address</th><th>Status</th></tr></thead><tbody id="suppliers-content"></tbody></table></div>
                    </div>
                    <div id="mtab-inventory" class="proj-section">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                            <div><h3 style="color: var(--text-dark); font-weight: 800; font-size: 1.1rem;">Site Inventory</h3></div>
                            <button class="btn" onclick="app.openModal('modal-add-stock')"><i class="fa-solid fa-box-open"></i> Add Stock</button>
                        </div>
                        <div class="table-responsive"><table class="sheet-table" id="table-inventory"><thead><tr><th>Item Name</th><th>Category</th><th>Current Stock</th><th>Unit Cost</th><th>Preferred Supplier</th></tr></thead><tbody id="inventory-content"></tbody></table></div>
                    </div>
                </div>
            </section>
                ...
                <div id="manpower-folders-view">
                    <div class="card">
                        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:24px;">
                            <h3 style="font-weight:800; font-size:1.2rem;"><i class="fa-solid fa-address-card"></i> Manpower Records</h3>
                        </div>
                        <div class="form-grid">
                    ...
                    <div class="card">
                        <h3 style="margin-bottom: 16px; font-weight:800; font-size:1.1rem;"><i class="fa-solid fa-tags"></i> Skill Categories</h3>
            ...
            <section id="mod-award_costs" class="module">
                <div class="card">
                    <div class="card-header"><h3><i class="fa-solid fa-clipboard-list"></i> Award Cost Masterlist</h3></div>
                    <div class="form-grid">
                    ...
                    <div class="table-responsive"><table class="sheet-table" id="table-award-costs"><thead><tr><th>Job Description</th><th>Amount (₱)</th><th>Action</th></tr></thead><tbody></tbody></table></div>
                </div>
            </section>
            ...
            <section id="mod-payroll" class="module">
                <div id="payroll-active-view">
                    <div class="card">
                        ...
                        <div class="form-grid" style="grid-template-columns: 1fr 1.5fr 2fr 1fr 1fr; align-items:center; background: #F8FAFC;">
            ...
            <section id="mod-cash_release" class="module">
                <div class="quick-stats-grid" style="grid-template-columns: repeat(4, 1fr);">
                    ...
                    <div class="stat-card"><div class="stat-details"><h3>Other Expenses</h3><h2 id="cr-total-others">₱0.00</h2></div><div class="stat-icon" style="background:#FEE2E2; color:#EF4444;"><i class="fa-solid fa-receipt"></i></div></div>
                    <div class="stat-card"><div class="stat-details"><h3>Grand Total</h3><h2 id="cr-grand-total">₱0.00</h2></div><div class="stat-icon" style="background:#D1FAE5; color:#10B981;"><i class="fa-solid fa-wallet"></i></div></div>
                </div>

                <div class="card">
                    <div class="card-header">
                        <h3><i class="fa-solid fa-hand-holding-dollar" style="color:var(--text-dark);"></i> Cash Release Log</h3>
                        <p>Log all outgoing cash for materials, labor, and other expenses.</p>
                    </div>

                    <div class="form-grid" style="grid-template-columns: 1fr 1fr 1.5fr 2fr 1.5fr auto; align-items:center;">
                        ...
                        <input type="text" id="cr-amount" placeholder="Amount (₱)" oninput="app.formatCurrencyInput(this)">
                        <button class="btn" onclick="app.addCashRelease()"><i class="fa-solid fa-plus"></i> Add Record</button>
                    </div>

                    <div class="table-responsive" style="margin-top: 20px;">
                        <table class="sheet-table" id="table-cash-release">
                            <thead><tr><th>DATE</th><th>CATEGORY</th><th>RECEIVER NAME</th><th>PARTICULARS</th><th>AMOUNT (₱)</th><th style="width: 50px;">ACTION</th></tr></thead>
            ...
            <section id="mod-global_ntp" class="module">
                <div class="card">
                    <div class="card-header"><h3><i class="fa-solid fa-file-signature"></i> Notice to Proceed (NTP)</h3><p>Upload verified NTPs here to unlock a Pending project's execution phases.</p></div>
                    <div class="form-grid">
                        ...
                        <div style="grid-column: 1/-1; display:flex; justify-content:flex-end;">
                            <button class="btn" onclick="app.uploadGlobalNTP()"><i class="fa-solid fa-upload"></i> Upload NTP</button>
                        </div>
                    </div>
                    <div class="table-responsive"><table class="sheet-table" id="table-global-ntp"><thead><tr><th>Project</th><th>Ticket</th><th>NTP Date</th><th>Award Cost</th><th>Due Date</th><th>Accept Date</th><th>Document</th></tr></thead><tbody></tbody></table></div>
                </div>
            </section>
    ...
    <div id="modal-add-supplier" class="modal-overlay" onclick="app.closeModalOnBackdrop(event, 'modal-add-supplier')" style="display: none;">
        <div class="modal-container">
            <div class="modal-header"><h3><i class="fa-solid fa-truck-field" style="color: var(--primary-hover);"></i> Add New Supplier</h3><button class="modal-close" onclick="app.closeModal('modal-add-supplier')"><i class="fa-solid fa-xmark"></i></button></div>
            <div class="modal-body">
                ...
                <div><label class="modal-label">Items Provided</label><input type="text" id="new-sup-materials" placeholder="e.g. Cement, Rebars"></div>
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px;"><div><label class="modal-label">Contact Number</label><input type="text" id="new-sup-contact" placeholder="0917-XXX-XXXX"></div><div><label class="modal-label">Email</label><input type="email" id="new-sup-email" placeholder="contact@supplier.com"></div></div>
            </div>
            <div class="modal-footer"><button class="btn-outline" onclick="app.closeModal('modal-add-supplier')">Cancel</button><button class="btn" onclick="app.submitNewSupplier()">Save Supplier</button></div>
        </div>
    </div>

    <div id="modal-add-stock" class="modal-overlay" onclick="app.closeModalOnBackdrop(event, 'modal-add-stock')" style="display: none;">
        <div class="modal-container">
            <div class="modal-header"><h3><i class="fa-solid fa-box-open" style="color: var(--primary-hover);"></i> Add Stock Item</h3><button class="modal-close" onclick="app.closeModal('modal-add-stock')"><i class="fa-solid fa-xmark"></i></button></div>
            <div class="modal-body">
                <div><label class="modal-label">Item Name</label><input type="text" id="stock-name" placeholder="e.g. Portland Cement"></div>
                <div><label class="modal-label">Category</label><select id="stock-category" onchange="app.handleCategoryChange(this.value)"></select><input type="text" id="stock-category-new" placeholder="Type new category..." style="display: none; margin-top: 8px;"></div>
                <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 12px;"><div><label class="modal-label">Stock</label><input type="number" id="stock-qty" placeholder="0"></div><div><label class="modal-label">Unit</label><input type="text" id="stock-unit" placeholder="Bags"></div><div><label class="modal-label">Unit Cost (₱)</label><input type="number" id="stock-cost" placeholder="0.00"></div></div>
                <div><label class="modal-label">Preferred Supplier</label><select id="stock-supplier"></select></div>
            </div>
            <div class="modal-footer"><button class="btn-outline" onclick="app.closeModal('modal-add-stock')">Cancel</button><button class="btn" onclick="app.submitNewStock()">Save Item</button></div>
        </div>
    </div>

    <div id="modal-edit-payroll" class="modal-overlay" onclick="app.closeModalOnBackdrop(event, 'modal-edit-payroll')" style="display: none;">
        <div class="modal-container">
            <div class="modal-header"><h3><i class="fa-solid fa-pencil" style="color: var(--primary-hover);"></i> Edit Payroll Record</h3><button class="modal-close" onclick="app.closeModal('modal-edit-payroll')"><i class="fa-solid fa-xmark"></i></button></div>
            <div class="modal-body">
                <input type="hidden" id="edit-pay-id">
                <div><label class="modal-label">Award Cost (₱)</label><input type="text" id="edit-pay-award" oninput="app.formatCurrencyInput(this)"></div>
                <div><label class="modal-label">Cash Advance (₱)</label><input type="text" id="edit-pay-advance" oninput="app.formatCurrencyInput(this)"></div>
            </div>
            <div class="modal-footer"><button class="btn-outline" onclick="app.closeModal('modal-edit-payroll')">Cancel</button><button class="btn" onclick="app.saveEditedPayroll()">Save Changes</button></div>
        </div>
    </div>
